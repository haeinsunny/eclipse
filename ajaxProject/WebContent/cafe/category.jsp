				...
				<div id="carouselExampleIndicators" class="carousel slide my-4"
					...
					<div class="carousel-inner" role="listbox">
						<div class="carousel-item active">
							<img class="d-block img-fluid" src="../images/coffee1.jpg"
								alt="First slide">
						</div>
						<div class="carousel-item">
							<img class="d-block img-fluid" src="../images/sec_coffee1.jpg"
								alt="Second slide">
						</div>
						<div class="carousel-item">
							<img class="d-block img-fluid" src="../images/thd_coffee1.jpg"
								alt="Third slide">
						</div>
					</div>
