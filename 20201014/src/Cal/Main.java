...
//		}
//		ObservableList<ch.makery.adderss.model.Person> list = FXCollections.observableArrayList();
//		list.add(new ch.makery.adderss.model.Person());
//
//		for (ch.makery.adderss.model.Person p : list) {
//			System.out.println(p.getStreet());
//		}
//		Map<String, String> map = new HashMap<>();
//		map.put("firstname", "수연");
//
//	}
//
...
//	}
	...
	public static int sumAry(int[] intAry) {
		int sum = 0;
		for(int i = 0; i < intAry.length; i++) {
			sum += intAry[i];
		}
